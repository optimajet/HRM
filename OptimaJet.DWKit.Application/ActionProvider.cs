...
namespace OptimaJet.DWKit.Application
{
    public class ActionProvider : OptimaJet.Workflow.Core.Runtime.IWorkflowActionProvider
    {
        ...
        public ActionProvider()
        {
            ...
            _conditions.Add("CheckNoneAuthorManager", CheckNoneAuthorManager);
        }

        private bool CheckNoneAuthorManager(ProcessInstance processInstance, WorkflowRuntime runtime, string parameter)
        {
